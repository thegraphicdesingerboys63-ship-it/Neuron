...
async function initApp() {
  ...
  currentUser = data;
  // normalize field name from server (tosAccepted → tos_accepted)
  if (currentUser.tosAccepted !== undefined) currentUser.tos_accepted = currentUser.tosAccepted;
  ...
  if (!currentUser.tos_accepted && !currentUser.tosAccepted) { show('tos-modal'); return; }
  await bootApp();
}
